...
console.log(3 * 4)
console.log(10 / 2)
console.log(7 % 5) //나머지 연산자 % : 나누고 나머지를 출력*/ /*//할당 연산자(assignment operator)

let a = 2
// a = a + 1
a += 1

console.log(a)*/ /*//비교 연산자(comparison operator)
...
console.log(a !== b)
console.log(a <= b)*/ /*//논리 연산자(logical operator)
...
console.log('!: ', !a) // not 부정*/ /*//삼항 연산자(ternary operator)
...
console.log(a ? '참' : '거짓')*/ /*// 조건문 (If statement)
...
console.log(sum(1,3))*/ /*function sum(){
  console.log(arguments)
  return arguments [0] + arguments
}

console.log(sum(7,3))*/ //화살표 함수
// () => {} vs function () {}
// 일부내용을 생략해 축약형으로 가능
